...
<h1>Get your Metadata</h1>
  ...
  <h5>Don't forget to put the version!!</h5>
	<h6>The format MUST BE "nameofmethod-version" and the version mus have the format "number.number"</h6>
  <br>
  <div class="text-field" id="labelinput"><g:textField name="name" pattern=".*-v\\d*.\\d*" placeholder="tcoffee-v1.0" /></div>
  <div class="row">
    <center>
